...
/*   Updated: 2023/10/11 16:37:00 by ralves-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (size == 64)
		create_object((*sp()).bee_left.img, c, size, 'P');
	if (size == 48)
		create_object((*sp()).bee_left_48.img, c, size, 'P');
	if (size == 32)
		create_object((*sp()).bee_left_32.img, c, size, 'P');
	if (size == 16)
		create_object((*sp()).bee_left_16.img, c, size, 'P');
}
